<p align="right">
  <a href="https://github.com/JesterDX">
    <img src="https://img.shields.io/badge/🌐%20Español-28a745?style=for-the-badge">
  </a>
</p>
...
<ul>
  ...
  <li>💻 Focused on backend development and logic</li>
  <li>🧠 Strong in problem solving and business rules</li>
  <li>🌐 Web development with React</li>
  <li>🗄️ SQL Server, MySQL and PostgreSQL</li>
  <li>🔐 Data validation and structured logic</li>
  <li>🌐 Networking (IP, subnetting, Cisco)</li>
  <li>🌍 Intermediate - Advanced technical English</li>
